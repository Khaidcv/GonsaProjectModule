      ...
      //  private readonly bosConfigcontext _db;
        ...
        public async Task<IdentityResult> CreateAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                await connection.QuerySingleAsync<string>($@"bos_regUser", new
                {
        ...
        //    {
        //        await connection.OpenAsync(cancellationToken);
        //        return await connection.QuerySingleOrDefaultAsync<ApplicationUser>($@"bosGetUserByLoginName_Onl");
        //    }
        //}

        public async Task<ApplicationUser> FindByNameAsync(string LognName, CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
            using (var connection = new SqlConnection(_connectionString))
            {
